...
class Seventh_Traditioner {
    ...
    public function enqueue_frontend_assets() {
        ...
        // We pass the client ID to JavaScript for dynamic loading
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
    ...
    public function ajax_get_contribution_details() {
        ...
        <table class="widefat">
            ...
            <?php if ($contribution->contribution_type === 'group' && isset($contribution->meeting_day) && $contribution->meeting_day !== '' && $contribution->meeting_day !== null) : ?>
            <tr>
